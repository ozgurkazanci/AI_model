...
_LIB_DIRS = ":".join([
    ...
    f"{SPECTRE_INSTALL}/tools.lnx86/TPtools/grpc-1.57.0/lib",
    f"{SPECTRE_INSTALL}/tools.lnx86/TPtools/abseil-20230802.1/lib",
    f"{SPECTRE_INSTALL}/tools.lnx86/TPtools/openssl-3.0.7/lib",
    f"{SPECTRE_INSTALL}/tools.lnx86/TPtools/libstdc++6-13.2.0/lib",
    f"{SPECTRE_INSTALL}/tools.lnx86/TPtools/gcclib-12.3.0/lib",
    f"{SPECTRE_INSTALL}/tools.lnx86/TPtools/icu-67.1/lib",
    f"{SPECTRE_INSTALL}/tools.lnx86/TPtools/zlib-1.2.11/lib",
    f"{SPECTRE_INSTALL}/tools.lnx86/TPtools/libffi-3.4.2/lib",
])
